    ...
    <figure className="relative mx-auto max-w-md text-center lg:mx-0 lg:text-left -mt-10">
      ...
      <blockquote className="mt-2">
        <p className="font-display text-xl font-medium text-slate-900">
          “This is easily the best resource to outsource job search-n-apply, offered at an affordable price .”
        </p>
      </blockquote>
  ...
  return (
    <header className="overflow-hidden bg-slate-100 lg:bg-transparent lg:px-5 ">
      ...
      <div className="relative flex items-end lg:col-span-5 lg:row-span-2">
          ...
          <div className="relative z-10 -mx-36 flex w-96 rounded-e-full px-2 overflow-hidden bg-transparent shadow-xl md:w-80 lg:w-auto">
